...
If you have followed all instructions and the app still does not run, please email cmardev\<at\> perennia.ca with the subject line "CMAR Sensor Validation App Issue". Include a copy of your zip folder and a screenshot of any error messages.
...
- the timestamp for all files must be in the same time zone.
